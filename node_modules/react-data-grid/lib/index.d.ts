...
export declare interface CellRendererProps<TRow, TSummaryRow> extends Pick<RowRendererProps<TRow, TSummaryRow>, 'row' | 'rowIdx' | 'selectCell'>, Omit_2<React.HTMLAttributes<HTMLDivElement>, 'style' | 'children' | 'onClick' | 'onDoubleClick' | 'onContextMenu'> {
    column: CalculatedColumn<TRow, TSummaryRow>;
...
export declare function headerRenderer<R, SR>({ column, sortDirection, priority, onSort, tabIndex }: HeaderRendererProps<R, SR>): JSX_2.Element;
...
export declare function SelectCellFormatter({ value, tabIndex, disabled, onChange, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy }: SelectCellFormatterProps): JSX_2.Element;
...
declare type SharedInputProps = Pick<CheckboxFormatterProps, 'disabled' | 'tabIndex' | 'aria-label' | 'aria-labelledby'>;
...
export declare function ToggleGroup<R, SR>({ groupKey, isExpanded, tabIndex, toggleGroup }: GroupFormatterProps<R, SR>): JSX_2.Element;
